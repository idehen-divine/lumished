...
<head>
    ...
    <title>Shelfie - Password Reset</title>
</head>
                    ...
                    <tr>
                        <td bgcolor="#FFFFFF" style="padding: 40px 30px;">
                            ...
                            <p style="font-size: 16px; color: #333333;">
                                Your password reset code for Shelfie is:
                            </p>
                            <div style="font-size: 24px; font-weight: bold; text-align: center; padding: 10px 0; color: #2DBB54;">
                                {{ $otp }}
                            </div>
                            <p style="font-size: 16px; color: #333333;">
                                Please enter this code to reset your password. This code is valid for a limited time and should not be shared with anyone.
                            </p>
                            <p style="font-size: 16px; color: #333333;">
