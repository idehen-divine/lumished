...
## Project conventions (MEMORY.md, inlined, enforce these)
...
3. Read a spec path only if it governs the changed code. Check the change against MEMORY.md conventions.
