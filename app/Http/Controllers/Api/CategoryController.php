...
class CategoryController extends Controller
{
     ...
     *
     * Retrieves all categories belonging to the authenticated customer's store.
    ...
    {
        return $this->categoryService->getUserStoreCategories()->toJson();
    }

    /**
     * Create a new category.
     *
     * Creates a new category under the authenticated customer's store.
    ...
    {
        return $this->categoryService->createCategory($request->validated())->toJson();
    }
    ...
    {
        return $this->categoryService->getCategory($id)->toJson();
    }

    /**
     * Update a category.
     *
     * Updates the category name, description, or parent.
     *
     * @group Customer Management
     *
     * @subgroup Categories
    ...
    {
        return $this->categoryService->updateCategory($id, $request->validated())->toJson();
    }

    /**
     * Delete a category.
     *
     * Deletes the category. Child categories are reparented to the deleted category's parent.
     *
     * @group Customer Management
     *
     * @subgroup Categories
    ...
    {
        return $this->categoryService->deleteCategory($id)->toJson();
    }
}
